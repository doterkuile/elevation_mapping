...
class ElevationMap {
 public:
   ...
   */
  void setRawSubmapHeight(const grid_map::Position& initPosition, float mapHeight, float mapRoll, float mapPitch, double lengthInXSubmap, double lengthInYSubmap,
                          double margin);
